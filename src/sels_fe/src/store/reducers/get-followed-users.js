...
const getFollowedUsersReducer = (state=initialState, action ) => {
  switch (action.type) {
    case GET_FOLLOWED_USER_SUCCESS: return getFollowedUserSuccess(state, action)     
    case GET_FOLLOWED_USER_FAIL: return getFollowedUserFail(state, action) 
    case FOLLOW_USER_SUCCESS: return followUserSuccess(state, action)     
    case FOLLOW_USER_FAIL: return followUserFail(state, action) 
    case UNFOLLOW_USER_SUCCESS: return unfollowUserSuccess(state, action)     
    case UNFOLLOW_USER_FAIL: return unfollowUserFail(state, action) 
